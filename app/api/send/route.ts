...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const { data, error } = await resend.emails.send({
      from: `Embassy <info@updates.example.com>`, //Title of our Email, here, our email will indicate Imam - Portfolio and the <info@eimaam.dev> will be the sending address. NB: `eimaam.dev` replace with your registered domain
      to: "babbu36790@gmail.com", // email receiver, // in case where you are sending onboarding emails, this field will be dynamic, it will be the email of the User
      subject: "Message from Embassy",
